...
contract('token contract', function(accounts) {
    ...
    // it("5.1 ttransfer to accounts[4](whitelisted), account[8], maybe success", function() {
    //     var value = new BigNumber(5);
    ...
    // it("4.2 approve and transfer to accounts[4](not whitelisted) test from accounts[6], maybe success", function() {
    //     var value = new BigNumber(5);
    //     return tokenContract.approve(accounts[4], value, {from:accounts[8]}).then(function(){
    //         tokenContract.transferFrom(accounts[8], accounts[5],value,{from:accounts[4]});
    //         return tokenContract.balanceOf(accounts[5]);
    //     }).then(function(result) {
    //         // console.log("log : " + result.valueOf());
    //     }).catch(function(error) {
    //         assert( Helpers.throwErrorMessage(error), "expected throw got " + error);    
    //         return tokenContract.approve(accounts[4], new BigNumber(0), {from:accounts[2]});
    //     });
    // });

    // it("4.3 transfer to accounts[6](timelocked), must succeed", function() {
    //     var value = new BigNumber(5);
    //     return tokenContract.transfer(accounts[8], value, {from:accounts[7]}).then(function(result){
    //         return tokenContract.balanceOf(accounts[7]);
    //     }).then(function(result) {
    //         console.log("log : " + result.valueOf());
    //     }).catch(function(error) {
